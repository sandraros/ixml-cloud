...
*    lo_isxml_element->document = document.
*    lo_isxml_element->first_child = first_child.
*    lo_isxml_element->last_child = last_child.
    lo_isxml_element->name       = name.
    lo_isxml_element->namespace  = namespace.
*    lo_isxml_element->next_sibling = next_sibling.
*    lo_isxml_element->parent = parent.
    lo_isxml_element->prefix     = prefix.
*    lo_isxml_element->previous_sibling = previous_sibling.
  ...
  METHOD find_from_name_ns.
    ...
    WHILE lo_child IS BOUND.
      IF lo_child->type = if_ixml_node=>co_node_element.
        ...
        lo_isxml_element = lo_isxml_element->find_from_name_ns( iv_name  = iv_name
                                                                iv_nsuri = iv_nsuri ).
  ...
  METHOD zif_excel_ixml_element~find_from_name.
    rval = zif_excel_ixml_element~find_from_name_ns( name = name ).
  ENDMETHOD.
  ...
  METHOD zif_excel_ixml_element~get_attribute.
    rval = zif_excel_ixml_element~get_attribute_ns( name = name ).
  ENDMETHOD.
  ...
  METHOD zif_excel_ixml_element~get_attribute_ns.
    ...
    lo_isxml_attribute ?= zif_excel_ixml_element~get_attribute_node_ns( name = name
                                                                        uri  = uri ).
  ...
  METHOD zif_excel_ixml_element~get_elements_by_tag_name.
    rval = zif_excel_ixml_element~get_elements_by_tag_name_ns( name = name ).
  ENDMETHOD.
...
CLASS lcl_isxml_node IMPLEMENTATION.
  ...
  METHOD zif_excel_ixml_node~get_attributes.
    ...
    CHECK type = zif_excel_ixml_node=>co_node_element.
  ...
  METHOD zif_excel_ixml_node~get_name.
    ...
    CASE type.
      WHEN zif_excel_ixml_node=>co_node_attribute.
  ...
  METHOD zif_excel_ixml_node~get_value.
    ...
    CASE type.
      ...
      WHEN zif_excel_ixml_node=>co_node_document.
        rval = ''.
